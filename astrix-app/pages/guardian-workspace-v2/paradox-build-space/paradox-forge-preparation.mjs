...
export class ForgePreparationClient{
  constructor({workerFactory=()=>new Worker(new URL('./paradox-forge-worker.mjs?v=20260905-generation-review-1',import.meta.url),{type:'module',name:'paradox-forge'}),onStatus=()=>{},maxEntries=4,maxBytes=8*1024*1024}={}){
