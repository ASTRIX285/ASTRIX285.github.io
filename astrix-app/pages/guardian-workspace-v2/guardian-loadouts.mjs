...
function actionCopy(action,index,identity){
  ...
  if(action==='equip')return {eyebrow:'LIVE EQUIPMENT CHANGE',title:`EQUIP BUNGIE SLOT ${slot}?`,body:`Equip “${identity.name}” on ${guardian}. Destiny must be in orbit, a social space, or offline.`,confirm:'EQUIP THIS LOADOUT'};
