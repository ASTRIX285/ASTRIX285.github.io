...
const mobileCorrectionLink = document.querySelector('link[data-astrix-main-mobile-correction]') || document.createElement('link');
mobileCorrectionLink.rel = 'stylesheet';
mobileCorrectionLink.href = './guardian-main-mobile-correction.css?v=20260823-1';
mobileCorrectionLink.dataset.astrixMainMobileCorrection = 'true';
if (!mobileCorrectionLink.isConnected) document.head.appendChild(mobileCorrectionLink);
