...
import "./guardian-semantic-ui.mjs?v=20260904-weapon-tier-rows-1";
import { openArmourDrawer } from "./guardian-beta-runtime.mjs";
import { classifyArmourPlug } from "./guardian-semantic-resolver.mjs?v=20260904-weapon-tier-rows-1";
