...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-storage-recovery-1'),'Build Forge must load the authenticated baseline recovery runtime without stale page-specific header code');
