...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260906-complete-build-transfer-1'),'Build Forge must load the complete protected data transfer module graph');
