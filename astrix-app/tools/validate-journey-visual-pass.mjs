...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260905-worker-preflight-1'),'Build Forge must load the worker-safe generation and live-preflight correction without stale page-specific code');
