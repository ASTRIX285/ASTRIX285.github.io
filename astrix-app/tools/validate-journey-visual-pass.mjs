...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260906-max-loadout-popup-1'),'Build Forge must load the protected max loadout review module graph');
