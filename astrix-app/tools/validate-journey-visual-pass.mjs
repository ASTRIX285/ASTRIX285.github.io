...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-artifact-fit-1'),'Build Forge must load the compact Forge Loader handoff and verified Artifact fit module graph');
