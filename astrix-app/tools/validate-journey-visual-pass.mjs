...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-blank-mod-canvas-1'),'Build Forge must load the blank AI mod-canvas sequence without stale page-specific code');
