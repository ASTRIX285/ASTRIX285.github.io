...
assert.ok(characterHtml.includes('guardian-workspace-v2.mjs?v=20260903-loadout-intelligence-1'),'Character must load the verified owned-loadout module graph');
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-full-artifact-plan-1'),'Build Forge must load the complete Artifact-aware Exotic-constrained owned-inventory recommendation sequence without stale page-specific code');
