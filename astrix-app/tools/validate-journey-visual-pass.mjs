...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-memory-safe-transfer-1'),'Build Forge must load the memory-safe Forge transfer recovery without stale page-specific header code');
