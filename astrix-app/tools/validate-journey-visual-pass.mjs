...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-responsive-generation-1'),'Build Forge must load the responsive Artifact-aware owned-inventory recommendation sequence without stale page-specific code');
