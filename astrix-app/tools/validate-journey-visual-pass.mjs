...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-complete-build-forge-1'),'Build Forge must load the complete verified recommendation runtime without stale page-specific header code');
