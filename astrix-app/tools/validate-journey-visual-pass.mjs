...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260905-generate-state-2'),'Build Forge must load the generated-state correction without stale page-specific code');
