...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260905-manual-editor-2'),'Build Forge must load the manual editor and guarded Apply sequence without stale page-specific code');
