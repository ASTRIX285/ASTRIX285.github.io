...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-build-render-rescue-1'),'Build Forge must load the recovered-profile render rescue without stale page-specific header code');
