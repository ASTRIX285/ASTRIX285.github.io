...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260905-artifact-rule-restored-1'),'Build Forge must load the owned-inventory weapon recommendation sequence without stale page-specific code');
