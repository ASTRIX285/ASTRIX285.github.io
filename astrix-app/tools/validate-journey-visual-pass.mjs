...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-cross-system-loop-1'),'Build Forge must load the complete cross-system owned-inventory recommendation sequence without stale page-specific code');
