...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-elemental-options-loader-1'),'Build Forge must load the elemental option and in-page generation sequence without stale page-specific code');
