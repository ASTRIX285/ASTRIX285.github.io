...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-armour-row-3'),'Build Forge must load the responsive five-card recommendation runtime without stale page-specific header code');
