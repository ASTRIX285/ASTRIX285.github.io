...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-forge-intelligence-1'),'Build Forge must load the evidence-ranked responsive recommendation runtime without stale page-specific header code');
