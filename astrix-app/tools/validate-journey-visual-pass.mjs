...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-artifact-fit-journey-header-1'),'Build Forge must load the compact Forge Loader handoff, verified Artifact fit and Journey header module graph');
