...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-compact-selection-1'),'Build Forge must load the compact staged-armour recovery runtime without stale page-specific header code');
