...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-synergy-review-1'),'Build Forge must load the Artifact-aware owned-inventory recommendation sequence without stale page-specific code');
