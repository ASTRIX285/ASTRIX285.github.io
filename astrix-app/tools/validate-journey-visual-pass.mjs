...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-exotic-anchor-1'),'Build Forge must load the Exotic-constrained armour-led owned-inventory recommendation sequence without stale page-specific code');
