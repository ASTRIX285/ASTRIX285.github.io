...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-compact-source-handoff-1'),'Build Forge must load the compact protected Forge Loader armour handoff module graph');
