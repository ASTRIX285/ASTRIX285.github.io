...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260904-atomic-forge-transfer-1'),'Build Forge must load the atomic Forge transfer recovery without stale page-specific header code');
