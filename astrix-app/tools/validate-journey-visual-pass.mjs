...
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260903-protected-handoff-1'),'Build Forge must load the protected Forge Loader armour handoff module graph');
