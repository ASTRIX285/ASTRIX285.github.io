...
for(const [label,html,entryModule] of [
  ['Main',mainHtml,/guardian-workspace-v2\.mjs\?v=20260903-loadout-intelligence-1/],
  ['Build',buildHtml,/paradox-build-space\.mjs\?v=20260904-elemental-options-loader-1/]
]){
