...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-review-layout-1/,'Build Forge must refresh its parent module for the repaired Apply and review layout');
