...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-complete-build-transfer-1/,'Build Forge must refresh its parent module for the complete protected data transfer');
