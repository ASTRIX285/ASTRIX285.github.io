...
assert.match(mainHtml,/paradox-item-cards\.css\?v=20260904-paradox-card-2/,'Character must load the shared Paradox item-card framework');
assert.match(buildHtml,/paradox-item-cards\.css\?v=20260904-paradox-card-2/,'Build Forge must load the same Paradox item-card framework');
