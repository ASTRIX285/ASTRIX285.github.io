...
assert.match(journeyHtml,/journey\.mjs\?v=20260905-weapon-audit-1/,'Journey must load the progressive records runtime without stale header-positioning code');
