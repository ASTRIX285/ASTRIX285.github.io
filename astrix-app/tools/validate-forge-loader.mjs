...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-artifact-fit-1/,'Build Forge must load the compact handoff and verified Artifact fit without stale browser code.');
