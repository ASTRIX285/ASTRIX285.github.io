...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260904-exotic-anchor-1/,'Build Forge must load the Exotic-constrained armour-led recommendation sequence without stale browser code.');
