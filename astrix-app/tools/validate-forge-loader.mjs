...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260906-max-loadout-popup-1/,'Build Forge must load the protected max loadout review without stale browser code.');
