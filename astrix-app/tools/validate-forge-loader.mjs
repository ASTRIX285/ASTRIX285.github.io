...
assert.match(html,/forge-loader\.mjs\?v=20260906-page-refresh-1/,'Forge Loader must load the complete prepared payload and persistent refresh controls without a stale browser module.');
...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260906-all-page-data-1/,'Build Forge must load the prepared page payload generation without stale browser code.');
