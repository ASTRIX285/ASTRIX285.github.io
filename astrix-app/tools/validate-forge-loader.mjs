...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-responsive-build-forge-2/,'Build Forge must load the responsive handoff, recommendation review and shared command header without stale browser code.');
