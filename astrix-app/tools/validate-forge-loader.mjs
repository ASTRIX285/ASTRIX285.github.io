...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260905-generation-review-1/,'Build Forge must load the generated-review correction without stale browser code.');
