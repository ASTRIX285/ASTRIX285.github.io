...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260904-memory-safe-transfer-1/,'Build Forge must load the memory-safe atomic transfer without stale browser code.');
