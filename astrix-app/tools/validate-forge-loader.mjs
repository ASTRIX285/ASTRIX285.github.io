...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260904-synergy-review-1/,'Build Forge must load the Artifact-aware owned-inventory recommendation sequence without stale browser code.');
