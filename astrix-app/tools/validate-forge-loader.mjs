...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-compact-source-handoff-1/,'Build Forge must load the compact source handoff decoder without stale browser code.');
