...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-armour-row-3/,'Build Forge must load the responsive five-card handoff, recommendation review and shared command header without stale browser code.');
