...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260904-weapon-tier-rows-1/,'Build Forge must load the complete tier-aware recommendation sequence without stale browser code.');
