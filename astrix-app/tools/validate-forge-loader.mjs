...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-artifact-fit-journey-header-2/,'Build Forge must load the compact handoff, verified Artifact fit and Build-specific Journey header without stale browser code.');
