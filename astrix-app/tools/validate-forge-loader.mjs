...
assert.match(html,/forge-loader\.mjs\?v=20260903-storage-recovery-1/,'Forge Loader must load the authenticated storage-recovery handoff without a stale browser module.');
...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-storage-recovery-1/,'Build Forge must load the authenticated baseline recovery state without stale browser code.');
