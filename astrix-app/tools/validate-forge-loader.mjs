...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-build-render-rescue-1/,'Build Forge must load the compact selection and recovered-profile render rescue without stale browser code.');
