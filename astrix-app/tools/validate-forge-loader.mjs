...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260906-complete-build-transfer-1/,'Build Forge must load the complete protected build transfer without stale browser code.');
