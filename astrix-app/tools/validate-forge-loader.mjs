...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-complete-build-forge-1/,'Build Forge must load the complete handoff, recommendation review and shared command header without stale browser code.');
