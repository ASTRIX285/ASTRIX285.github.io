...
assert.match(html,/forge-loader\.mjs\?v=20260903-loadout-intelligence-1/,'Forge Loader must load the mod-free armour and owned-loadout evidence handoff without a stale browser module.');
...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260903-loadout-intelligence-1/,'Build Forge must load the responsive evidence-ranked handoff, recommendation review and shared command header without stale browser code.');
