...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260905-weapon-audit-1/,'Build Forge must load the complete verified weapon recommendation sequence without stale browser code.');
