...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260904-full-artifact-plan-1/,'Build Forge must load the complete Artifact-aware Exotic-constrained recommendation sequence without stale browser code.');
