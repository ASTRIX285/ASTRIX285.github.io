...
assert.match(workspace,/guardian-bungie-profile\.mjs\?v=20260906-all-page-data-1/,'Main must load the authenticated page payload profile without a stale module cache');
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260906-all-page-data-1/,'Main must load the prepared page payload dependency graph without a stale module cache');
...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-all-page-data-1/,'Build must load the prepared page payload dependency graph without stale code');
