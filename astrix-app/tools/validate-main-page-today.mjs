...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-max-loadout-popup-1/,'Build must load the max loadout popup dependency graph without stale code');
