...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260903-compact-selection-1/,'Build must load the compact staged-armour recovery runtime without stale code');
