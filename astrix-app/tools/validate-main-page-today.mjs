...
assert.match(buildHtml,/paradox-build-space\.css\?v=20260903-armour-row-3/,'Build must load the responsive five-card Build Forge presentation without a stale cache');
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260903-armour-row-3/,'Build must load the responsive verified recommendation runtime without stale code');
