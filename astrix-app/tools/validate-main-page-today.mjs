...
assert.match(workspace,/guardian-bungie-profile\.mjs\?v=20260905-worker-preflight-1/,'Main must load the authenticated build-binding profile without a stale module cache');
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260905-worker-preflight-1/,'Main must load the live-preflight dependency graph without a stale module cache');
