...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260904-memory-safe-transfer-1/,'Build must load the memory-safe Forge transfer recovery without stale code');
