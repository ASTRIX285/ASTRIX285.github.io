...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260904-responsive-generation-1/,'Build must load the responsive Artifact-aware inventory recommendation and test sequence without stale code');
