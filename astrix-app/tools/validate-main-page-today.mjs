...
assert.match(workspace,/guardian-bungie-profile\.mjs\?v=20260902-page-profile-scopes-2/,'Main must load the page-scoped profile correction without a stale profile-module cache');
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260902-page-profile-scopes-2/,'Main must load the corrected workspace dependency graph without a stale module cache');
...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260902-page-profile-scopes-2/,'Build must load the lightweight Character profile scope without a stale module cache');
