...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-page-data-recovery-1/,'Build must load the prepared page payload dependency graph without stale code');
