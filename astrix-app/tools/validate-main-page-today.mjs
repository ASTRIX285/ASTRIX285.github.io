...
assert.match(buildCss,/html body\.build-forge-page header:has\(>\[data-astrix-hero-cards\]\) \.guardian-character-card\.is-selected\{[^}]*border-color:rgba\(201,168,76,\.92\)!important;[^}]*rgba\(211,32,47,\.62\)/,'Build Forge must clearly identify the selected Working Build Guardian with a scoped gold-and-crimson treatment');
...
assert.match(buildHtml,/paradox-build-space\.css\?v=20260903-artifact-fit-journey-header-2/,'Build must load the verified Artifact fit and Build-specific Journey header presentation without a stale cache');
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260903-artifact-fit-journey-header-2/,'Build must load the verified Artifact recommendation runtime and Journey header balance without a stale module cache');
