...
assert.match(buildHtml,/paradox-build-space\.css\?v=20260903-responsive-build-forge-2/,'Build must load the responsive three-column Build Forge presentation without a stale cache');
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260903-responsive-build-forge-2/,'Build must load the responsive verified recommendation runtime without stale code');
