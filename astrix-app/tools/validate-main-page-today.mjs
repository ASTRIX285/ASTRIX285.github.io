...
assert.match(workspace,/guardian-bungie-profile\.mjs\?v=20260905-manual-editor-2/,'Main must load the verified manual-editor profile and exact-socket evidence without a stale module cache');
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260905-manual-editor-2/,'Main must load the manual loadout-action dependency graph without a stale module cache');
...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260905-manual-editor-2/,'Build must load the manual editor and guarded Apply release without stale code');
