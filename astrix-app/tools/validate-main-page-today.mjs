...
assert.match(buildHtml,/paradox-build-space\.mjs\?v=20260906-complete-build-transfer-1/,'Build must load the complete protected data transfer dependency graph without stale code');
