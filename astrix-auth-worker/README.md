# ASTRIX Destiny backend scaffold

This directory contains a Cloudflare Worker skeleton for the future ASTRIX Destiny backend.
...
Read `docs/ASTRIX-BACKEND-OAUTH-DESIGN.md` before changing any OAuth route or adding any secret.
